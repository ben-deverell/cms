...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group"><label for="post_author">Post Author</label>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="post_comment" id="body" cols="30" rows="10"><?php echo $post_comment; ?>   
    </textarea>
